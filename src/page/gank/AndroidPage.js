...
const baseHttp = 'http://gank.io/api/data/Android/';
...
export default class AndroidPage extends Component {
    ...
    renderItemView = ({ item }) => {
        return (
            <TouchableHighlight underlayColor='#00000000' onPress={this.onpressItem.bind(this, item.values)}
